...
public abstract class AbstractList<E extends AbstractList.AbstractListEntry<E>> extends FocusableGui implements IRenderable {
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        net.slate.ui.Skin.listBackground(this.x0, this.y0, this.x1, this.y1);
        ...
        net.slate.ui.Skin.listEdges(this.x0, this.x1, this.y0, this.y1);
        ...
        if (j1 > 0) {
            ...
            net.slate.ui.Skin.scrollbar(i, this.y0, j - i, this.y1 - this.y0, l1, k1);
        }
    ...
    protected void renderHoleBackground(int p_renderHoleBackground_1_, int p_renderHoleBackground_2_, int p_renderHoleBackground_3_, int p_renderHoleBackground_4_) {
        net.slate.ui.Skin.listHole(this.width, p_renderHoleBackground_1_, p_renderHoleBackground_2_);
    }
