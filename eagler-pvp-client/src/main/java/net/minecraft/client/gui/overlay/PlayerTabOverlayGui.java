...
public class PlayerTabOverlayGui extends AbstractGui {
   ...
   public void render(int width, Scoreboard scoreboardIn,  ScoreObjective scoreObjectiveIn) {
      ...
      if (this.header != null && !net.slate.module.impl.TabListModule.hideHeader()) {
      ...
      if (this.footer != null && !net.slate.module.impl.TabListModule.hideHeader()) {
   ...
   protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
      if (net.slate.module.impl.TabListModule.numericPing()) {
         int ping = networkPlayerInfoIn.getResponseTime();
         String s = ping < 0 ? "-" : Integer.toString(ping);
         int col = ping < 0 ? 0xFF888888 : (ping < 80 ? 0xFF5BD07A : (ping < 200 ? 0xFFE8B84B : 0xFFE8604B));
         this.mc.fontRenderer.drawStringWithShadow(s, (float)(p_175245_2_ + p_175245_1_ - 2 - this.mc.fontRenderer.getStringWidth(s)), (float)p_175245_3_, col);
         return;
      }
      GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
