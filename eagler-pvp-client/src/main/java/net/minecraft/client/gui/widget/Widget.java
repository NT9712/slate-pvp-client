...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener {
    ...
    public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
        ...
        net.slate.ui.Skin.button(this.x, this.y, this.width, this.height, this.isHovered(), this.active, this.alpha);
        this.renderBg(minecraft, p_renderButton_1_, p_renderButton_2_);
        int j = net.slate.ui.Skin.buttonText(this.isHovered(), this.active) & 0xFFFFFF;
