...
public class ChatScreen extends Screen {
    ...
    /** Text left in the box when the chat is closed without sending. */
    private static String draft = "";

    /** Dropped when leaving a world so a half typed message never follows you to another server. */
    ...
    protected void init() {
        ...
        this.inputField.setText(this.defaultInputFieldText.isEmpty() && net.slate.module.impl.ChatModule.keepsDraft()
                ? draft : this.defaultInputFieldText);
    ...
    public void removed() {
        draft = net.slate.module.impl.ChatModule.keepsDraft() && this.inputField != null ? this.inputField.getText() : "";
