...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   public void setPlayerSPHealth(float health) {
      net.slate.Slate.onHealthUpdate(health);
   ...
   public void livingTick() {
      ...
      if ((this.onGround || this.canSwim()) && !flag1 && !flag2 && this.func_223110_ee() && !this.isSprinting() && flag7 && !this.isHandActive() && !this.isPotionActive(Effects.BLINDNESS)) {
         if (this.sprintToggleTimer <= 0 && !this.mc.gameSettings.keyBindSprint.isKeyDown() && !net.slate.module.impl.ToggleSprintModule.sprintHeld()) {
      ...
      if (!this.isSprinting() && (!this.isInWater() || this.canSwim()) && this.func_223110_ee() && flag7 && !this.isHandActive() && !this.isPotionActive(Effects.BLINDNESS) && (this.mc.gameSettings.keyBindSprint.isKeyDown() || net.slate.module.impl.ToggleSprintModule.sprintHeld())) {
         this.setSprinting(true);
      }
