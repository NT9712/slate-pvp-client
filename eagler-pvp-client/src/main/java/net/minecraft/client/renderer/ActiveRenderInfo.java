...
public class ActiveRenderInfo {
   ...
   public void update(IBlockReader worldIn, Entity renderViewEntity, boolean thirdPersonIn, boolean thirdPersonReverseIn, float partialTicks) {
      ...
      this.setDirection(renderViewEntity.getYaw(partialTicks) + net.slate.module.impl.FreelookModule.yawOffset(),
            renderViewEntity.getPitch(partialTicks) + net.slate.module.impl.FreelookModule.pitchOffset());
